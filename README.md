...
If you receive an answer from the LF ticketing system that condtradicts anything you read on this page, feel free to raise a pull request, quoting the ticket number.
